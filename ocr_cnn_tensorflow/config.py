...
tf.app.flags.DEFINE_string("train_records_dir", "./resource/train.tfrecords", "picture dir")
tf.app.flags.DEFINE_string("test_records_dir", "./resource/test.tfrecords", "picture dir")
tf.app.flags.DEFINE_string("model_path", "./resource/save_v3/", "model path")
